...
function style() {
    var selectedBlocks = document.querySelectorAll('.active');
        selectedBlock = document.querySelector('input[name=category]:checked').closest('div');
...
class Joke {
    ...
    renderJoke() {
        ...
        var icon = `<img src="${this.icon_url}" class="icon">`;
    ...
    addFavourite() {
        ...
        if(favourites.querySelector(`div[data-id = copied_${this.id}]`) == null) {
            ...
            copiedBlock.addEventListener('click', () => {
